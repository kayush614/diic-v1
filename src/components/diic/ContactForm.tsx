      ...
      <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-6">
        ...
        <div>
          <label
            ...
            className="block text-[11px] font-bold uppercase tracking-widest text-gray-500 mb-2"
          >
          ...
          <input
            ...
            className={`${inputBase} ${
              errors.name
                ...
                : "border-input focus:border-[#1b4a92] focus:ring-[#1b4a92]/10"
            }`}
          />
          {errors.name && (
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`${inputBase} border-input focus:border-[#1b4a92] focus:ring-[#1b4a92]/10`}
          />
        </div>
